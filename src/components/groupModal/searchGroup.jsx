...
import { searchUsers, sendConnectionRequest } from "../../api/networkApi";
...
const SearchSearchModal = ({ open, onClose, onApiResponse }) => {
  ...
  // Fetch roles once
  useEffect(() => {
    Fetcher.get("/user/network/connectas-options")
      .then((res) => {
...
export default SearchSearchModal;
